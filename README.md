...
<head>
    ...
    <style>
        /* جميع الأنماط السابقة - نفس التنسيق */
        :root {
            --sky: #1a1a4e;
            --ocean: #0d3b6e;
            --island: #2d6a4f;
...
<div class="screen active" id="home">
    ...
    <div id="welcomeBack" style="display:none;margin-top:20px;text-align:center">
        ...
        <button class="start-btn" onclick="showMap()">🗺️ استمر في الرحلة!</button><br>
        <button onclick="resetUser()" style="margin-top:12px;background:transparent;border:1px solid rgba(255,255,255,0.3);color:rgba(255,255,255,0.6);padding:8px 20px;border-radius:20px;cursor:pointer;">🔄 لاعب جديد</button>
    </div>
</div>
...
<div class="screen" id="records">
    ...
    <table class="records-table" id="recordsTable">
        <thead><tr><th>الاسم</th><th>التاريخ</th><th>الوقت</th><th>النقاط</th><th>المستوى</th></tr></thead>
...
<script>
    ...
    (function() {
        ...
        for (let i = 0; i < 100; i++) {
            ...
            star.style.cssText = `left:${Math.random()*100}%; top:${Math.random()*100}%; width:${size}px; height:${size}px; --d:${Math.random()*3+2}s; animation-delay:${Math.random()*3}s;`;
    ...
    function pauseTimer() {
        if (gameState.sessionStart) {
            const diff = Math.floor((Date.now() - gameState.sessionStart) / 1000);
    ...
    function getTotalTime() {
        ...
        if (gameState.sessionStart) total += Math.floor((Date.now() - gameState.sessionStart) / 1000);
        return total;
    }
    ...
    const islands = [
        ...
        { title: "🏝️ جزيرة الصيغ والتحليل", c1: "#3498db", c2: "#2980b9", emoji: "📝",
          lessons: [
                { emoji:"📐", title:"مربع مجموع", type:"صيغ", activity:"u2l1" },
                { emoji:"📏", title:"مربع فرق", type:"صيغ", activity:"u2l2" },
                { emoji:"➗", title:"الفرق بين مربعين", type:"صيغ", activity:"u2l3" },
                { emoji:"🔍", title:"تحليل ثلاثي بسيط", type:"تحليل", activity:"u2l4" },
                { emoji:"🧩", title:"تحليل ثلاثي بمعامل", type:"تحليل", activity:"u2l5" },
                { emoji:"🔄", title:"العامل المشترك", type:"تحليل", activity:"u2l6" },
                { emoji:"📊", title:"تطبيقات التحليل", type:"تطبيقات", activity:"u2l7" }
          ] },
        { title: "🏝️ جزيرة العمليات", c1: "#2ecc71", c2: "#27ae60", emoji: "🧮",
          lessons: [
                { emoji:"➕", title:"جمع وطرح حقيقي", type:"عمليات", activity:"u3l1" },
                { emoji:"✖️", title:"ضرب حقيقي", type:"عمليات", activity:"u3l2" },
                { emoji:"➗", title:"قسمة حقيقية", type:"عمليات", activity:"u3l3" },
        ...
        { title: "🏝️ جزيرة المعادلات", c1: "#e74c3c", c2: "#c0392b", emoji: "⚖️",
          lessons: [
                { emoji:"🔍", title:"معادلة خطية خطوة", type:"معادلات", activity:"u4l1" },
                { emoji:"⚖️", title:"معادلة خطية خطوتين", type:"معادلات", activity:"u4l2" },
                { emoji:"📝", title:"معادلات بأقواس", type:"معادلات", activity:"u4l3" },
                { emoji:"📊", title:"معادلات بكسور", type:"معادلات", activity:"u4l4" },
                { emoji:"🔢", title:"تطبيقات المعادلات", type:"تطبيقات", activity:"u4l5" },
                { emoji:"🔀", title:"معادلات تربيعية بسيطة", type:"معادلات", activity:"u4l6" },
                { emoji:"📐", title:"حل بالتحليل", type:"معادلات", activity:"u4l7" }
          ] },
        { title: "🏝️ جزيرة العلاقات", c1: "#9b59b6", c2: "#8e44ad", emoji: "📈",
          lessons: [
                { emoji:"🔗", title:"المجال والمدى", type:"علاقات", activity:"u5l1" },
                { emoji:"📊", title:"تمثيل بياني", type:"علاقات", activity:"u5l2" },
    ...
    // ===== 5. بنوك الأسئلة (كل درس 10 أسئلة) =====
    const activities = {
        // الوحدة 1
        u1l1: [ // مفهوم الأسس
        ...
        u1l5: [ // جذر تربيعي
            ...
            { q: "√٦٤ =", opts: ["٨", "-٨", "٨ و -٨", "٤"], ans: 0 },
            { q: "√٠.٠٤ =", opts: ["٠.٢", "٠.٠٢", "٠.٤", "٠.٠٠٤"], ans: 0 },
            { q: "أي الأعداد مربع كامل؟", opts: ["١٦", "١٥", "١٧", "١٨"], ans: 0 },
        ...
        u1l6: [ // جذر تكعيبي
            ...
            { q: "أي الأعداد مكعب كامل؟", opts: ["٢٧", "٢٦", "٢٨", "٢٩"], ans: 0 },
            { q: "∛(٨×٦٤) =", opts: ["٨", "٤", "١٢", "١٦"], ans: 0 },
            { q: "∛١٠٠٠ =", opts: ["١٠", "١٠٠", "١٠٠٠", "٣٣.٣"], ans: 0 }
        ],
        u1l7: [ // تطبيقات الأسس والجذور
            { q: "مساحة مربع طول ضلعه ٥ سم =", opts: ["٢٥ سم²", "٢٠ سم", "٢٥ سم", "١٠ سم²"], ans: 0 },
            { q: "حجم مكعب طول حرفه ٤ سم =", opts: ["٦٤ سم³", "١٦ سم³", "٨ سم³", "٣٢ سم³"], ans: 0 },
            { q: "إذا كان ضلع مربع = √٢٥، فمساحته =", opts: ["٢٥", "٥", "١٠", "٢٠"], ans: 0 },
            { q: "إذا كان حجم مكعب = ٢٧ سم³، فطول حرفه =", opts: ["٣ سم", "٩ سم", "٢٧ سم", "٨١ سم"], ans: 0 },
            { q: "٤√ × ٩√ =", opts: ["٦", "٣٦", "١٢", "١٣"], ans: 0 },
            { q: "(٢⁴) × (٣²) =", opts: ["١٤٤", "٢٤", "٣٦", "٧٢"], ans: 0 },
            { q: "٥√ × ٢٠√ =", opts: ["١٠", "١٠٠", "٢٥", "٢٠"], ans: 0 },
            { q: "قانون مساحة المربع =", opts: ["ضلع × نفسه", "ضلع × ٤", "ضلع × ٢", "ضلع + نفسه"], ans: 0 },
        ...
        u2l2: [ // مربع فرق
            ...
            { q: "(٥-س)² = ٢٥ - ... + س²", opts: ["١٠س", "٥س", "٢س", "٢٥س"], ans: 0 },
            ...
            { q: "إذا كانت س=٤، ف (س-١)² =", opts: ["٩", "١٥", "٣", "٥"], ans: 0 },
        ...
        u2l3: [ // فرق مربعين
            ...
            { q: "٣٦س²-٢٥ = (٦س-٥)(......)", opts: ["٦س+٥", "٦س-٥", "٥-٦س", "٣٦س+٢٥"], ans: 0 },
            { q: "(١٠-٣)(١٠+٣) =", opts: ["٩١", "١٠٠-٩=٩١", "١٠٠-٦=٩٤", "١٠٠-٣=٩٧"], ans: 0 },
            { q: "إذا كانت س²-٤٩=٠، فإن س =", opts: ["٧ أو -٧", "٧", "-٧", "٤٩"], ans: 0 }
        ],
        u2l4: [ // تحليل ثلاثي بسيط
            ...
            { q: "س²+١١س+٢٤ =", opts: ["(س+٣)(س+٨)", "(س+٤)(س+٦)", "(س+٢)(س+١٢)", "(س+١)(س+٢٤)"], ans: 0 },
            { q: "س²-١٢س+٣٥ =", opts: ["(س-٥)(س-٧)", "(س+٥)(س+٧)", "(س-١)(س-٣٥)", "(س-٥)(س+٧)"], ans: 0 }
        ],
        u2l5: [ // تحليل ثلاثي بمعامل
        ...
        u2l6: [ // عامل مشترك
            ...
            { q: "٢٥س²-٣٦ =", opts: ["(٥س-٦)(٥س+٦)", "٥(٥س²-٧.٢)", "٢٥(س²-١.٤٤)", "لا يمكن"], ans: 0 },
            { q: "ع.م.أ لـ ٦س³, ٩س², ١٢س هو:", opts: ["٣س", "٣س²", "٦س", "٣"], ans: 0 },
            { q: "٥س²+٢٠س =", opts: ["٥س(س+٤)", "٥(س²+٤س)", "س(٥س+٢٠)", "٥س(س+٤)"], ans: 0 },
            { q: "٧أ²ب-١٤أب² =", opts: ["٧أب(أ-٢ب)", "٧أب(أ+٢ب)", "أب(٧أ-١٤ب)", "٧أ(أب-٢ب²)"], ans: 0 }
        ],
        u2l7: [ // تطبيقات التحليل
            { q: "إذا كانت س=٢، ص=٣، فاحسب س²+٢س ص+ص²", opts: ["٢٥", "١٣", "٣٦", "٥"], ans: 0 },
            { q: "حل س²-٩=٠", opts: ["س=٣ أو -٣", "س=٣", "س=-٣", "س=٩"], ans: 0 },
            { q: "مساحة مستطيل (س+٣)(س+٢) =", opts: ["س²+٥س+٦", "س²+٦س+٦", "س²+٥س+٥", "س²+٦س+٥"], ans: 0 },
            { q: "إذا كان (س+١)²=٢٥، فما س؟", opts: ["٤ أو -٦", "٤", "-٦", "٢٤"], ans: 0 },
            { q: "قيمة ٩٩² =", opts: ["(١٠٠-١)² = ١٠٠٠٠-٢٠٠+١ = ٩٨٠١", "٩٩٠٠", "١٠٠٠٠-٩٩", "٩٨٠٠"], ans: 0 },
            { q: "٤٩-٢٥ =", opts: ["(٧-٥)(٧+٥)=٢×١٢=٢٤", "٢٤", "٤٩-٢٥=٢٤", "جميع ما سبق"], ans: 3 },
            { q: "إذا كان س²+٦س+٩=٠، فإن س =", opts: ["-٣", "٣", "٦", "-٦"], ans: 0 },
            { q: "مساحة مربع طول ضلعه (س+٢) =", opts: ["س²+٤س+٤", "س²+٤", "س²+٢س+٤", "س²+٤س+٢"], ans: 0 },
            { q: "١٠١²-٩٩² =", opts: ["(١٠١-٩٩)(١٠١+٩٩)=٢×٢٠٠=٤٠٠", "٤٠٠", "٢٠٠", "٤٠٠٠"], ans: 0 },
            { q: "إذا كان (س-٥)²=٠، فإن س =", opts: ["٥", "-٥", "٢٥", "٠"], ans: 0 }
        ],

        // الوحدة 3 (مختصرة للطول)
        u3l1: [ // جمع وطرح حقيقي
        ...
        u3l2: [ // ضرب حقيقي
            ...
            { q: "(٢+√٣)² =", opts: ["٤+٤√٣+٣=٧+٤√٣", "٧+٤√٣", "٧", "٤+٢√٣+٣"], ans: 0 },
        ...
        u3l3: [ // قسمة حقيقية
            ...
            { q: "١٠÷√٥ =", opts: ["١٠√٥/٥=٢√٥", "٢√٥", "√٢", "٢٠"], ans: 0 },
            { q: "إذا كان س=√٢٠، ص=√٥، فما س÷ص؟", opts: ["٢", "٤", "√٤=٢", "√١٥"], ans: 0 }
        ],
        u3l4: [ // ترتيب وعمليات
            { q: "رتب تصاعدياً: √٤، √٩، √١٦", opts: ["٢،٣،٤", "٤،٣،٢", "٤،٢،٣", "٢،٤،٣"], ans: 0 },
            { q: "أيهما أكبر √٣٥ أم ٦؟", opts: ["√٣٥≈٥.٩، إذاً ٦ أكبر", "٦", "√٣٥", "متساويان"], ans: 0 },
            { q: "٢+٣×٤ =", opts: ["٢+١٢=١٤", "٢٠", "١٤", "٢٤"], ans: 0 },
            { q: "(٢+٣)×٤ =", opts: ["٥×٤=٢٠", "٢٠", "١٤", "٢٤"], ans: 0 },
            { q: "إذا كان أ=٣، ب=٢، فاحسب أ²+ب", opts: ["٩+٢=١١", "١١", "١٣", "٧"], ans: 0 },
            { q: "رتب تنازلياً: ٥، √٢٧، √٨", opts: ["٥، √٢٧، √٨", "√٢٧، ٥، √٨", "٥، √٨، √٢٧", "√٢٧، √٨، ٥"], ans: 0 },
            { q: "أيهما أصغر √٨ أم ٣؟", opts: ["√٨≈٢.٨، إذاً √٨ أصغر", "٣", "√٨", "متساويان"], ans: 0 },
            { q: "١٠-٤÷٢ =", opts: ["١٠-٢=٨", "٨", "٣", "١٢"], ans: 0 },
            { q: "٤²-٤ =", opts: ["١٦-٤=١٢", "١٢", "٤", "٠"], ans: 0 },
            { q: "قارن √(٧+٩) و √٧+√٩", opts: ["√١٦=٤، √٧+√٩≈٥.٦، الثاني أكبر", "الثاني أكبر", "الأول أكبر", "متساويان"], ans: 0 }
        ],
        u3l5: [ // خواص العمليات
            { q: "خاصية الإبدال في الجمع:", opts: ["أ+ب = ب+أ", "أ+(ب+جـ) = (أ+ب)+جـ", "أ+٠=أ", "أ+(-أ)=٠"], ans: 0 },
            { q: "خاصية التجميع في الضرب:", opts: ["(أ×ب)×جـ = أ×(ب×جـ)", "أ×ب = ب×أ", "أ×١=أ", "أ×٠=٠"], ans: 0 },
            ...
            { q: "أي العبارات صحيحة؟", opts: ["الجمع إبدالي", "الطرح إبدالي", "القسمة إبدالية", "جميع ما سبق"], ans: 0 },
            { q: "الضرب عملية تجميعية؟", opts: ["نعم", "لا", "أحياناً", "فقط للأعداد الصحيحة"], ans: 0 },
            { q: "٣×(٥-٢) = (٣×٥)-(٣×٢) تمثل خاصية", opts: ["التوزيع", "الإبدال", "الدمج", "المحايد"], ans: 0 }
        ],

        // الوحدة 4
        u4l1: [ // معادلات خطوة واحدة
            { q: "حل س+٥=١٢", opts: ["س=٧", "س=١٧", "س=٦٠", "س=٢"], ans: 0 },
            { q: "حل س-٤=٩", opts: ["س=١٣", "س=٥", "س=٣٦", "س=-٥"], ans: 0 },
            { q: "حل ٣س=٢٤", opts: ["س=٨", "س=٢١", "س=٢٧", "س=١٢"], ans: 0 },
            { q: "حل س/٥=٦", opts: ["س=٣٠", "س=١١", "س=١.٢", "س=٢٥"], ans: 0 },
            { q: "إذا كانت س+٨=٢٠، فإن س =", opts: ["١٢", "٢٨", "١٦٠", "٢.٥"], ans: 0 },
            { q: "إذا كانت ٧س=٤٢، فإن س =", opts: ["٦", "٤٩", "٢٩٤", "٣٥"], ans: 0 },
            { q: "حل ص-٣=١٠", opts: ["ص=١٣", "ص=٧", "ص=٣٠", "ص=-٧"], ans: 0 },
            { q: "حل ٤م=٣٦", opts: ["م=٩", "م=٤٠", "م=٣٢", "م=١٤٤"], ans: 0 },
            { q: "حل ن/٢=٨", opts: ["ن=١٦", "ن=٤", "ن=١٠", "ن=٦"], ans: 0 },
            { q: "إذا كانت س+١٢=٣٠، فإن س =", opts: ["١٨", "٤٢", "٢.٥", "٣٦٠"], ans: 0 }
        ],
        u4l2: [ // معادلات خطوتين
            { q: "حل ٢س+٣=٩", opts: ["س=٣", "س=٦", "س=١٢", "س=٢٤"], ans: 0 },
            { q: "حل ٣س-٥=٧", opts: ["س=٤", "س=٢", "س=١٢", "س=٣٦"], ans: 0 },
            { q: "حل ٤س+٧=١٩", opts: ["س=٣", "س=١٢", "س=٢٦", "س=٦.٥"], ans: 0 },
            { q: "حل ٥س-٢=١٣", opts: ["س=٣", "س=١١", "س=١٥", "س=٥٥"], ans: 0 },
            { q: "إذا كانت ٢س+٥=١٥، فإن س =", opts: ["٥", "١٠", "٢٠", "٣"], ans: 0 },
            { q: "إذا كانت ٣س-٤=٨، فإن س =", opts: ["٤", "١٢", "٣", "٢٤"], ans: 0 },
            { q: "حل ٦س+١=٣١", opts: ["س=٥", "س=٣٠", "س=٣٢", "س=١.٨"], ans: 0 },
            { q: "حل ٧س-٨=١٣", opts: ["س=٣", "س=٢١", "س=٥", "س=١٠٥"], ans: 0 },
            { q: "حل ٨س+٤=٢٠", opts: ["س=٢", "س=١٦", "س=٢٤", "س=٣"], ans: 0 },
            { q: "إذا كانت ٤س+٩=٢٥، فإن س =", opts: ["٤", "١٦", "٣٤", "٦"], ans: 0 }
        ],
        u4l3: [ // معادلات بأقواس
            { q: "حل ٢(س+٣)=١٠", opts: ["س=٢", "س=٧", "س=٥", "س=٤"], ans: 0 },
            { q: "حل ٣(س-٢)=١٢", opts: ["س=٦", "س=١٠", "س=٤", "س=٣٨"], ans: 0 },
            { q: "حل ٤(٢س+١)=٢٠", opts: ["س=٢", "س=٤", "س=٦", "س=٣"], ans: 0 },
            { q: "حل ٥(س-٣)=٢٠", opts: ["س=٧", "س=٤", "س=٨", "س=٢٣"], ans: 0 },
            { q: "إذا كانت ٢(٣س-١)=١٦، فإن س =", opts: ["٣", "٥", "٤", "٢"], ans: 0 },
            { q: "إذا كانت ٤(س+٥)=٢٨، فإن س =", opts: ["٢", "٧", "١٢", "٣"], ans: 0 },
            { q: "حل ٣(س+٢)-٤=١١", opts: ["س=٣", "س=٥", "س=٤", "س=٢"], ans: 0 },
            { q: "حل ٢(٢س-١)+٣=١٣", opts: ["س=٣", "س=٤", "س=٢", "س=٥"], ans: 0 },
            { q: "حل ٥(س-٢)=٣س+٤", opts: ["س=٧", "س=٦", "س=٥", "س=٨"], ans: 0 },
            { q: "حل ٢(س+٣)=٣(س-١)", opts: ["س=٩", "س=٦", "س=٣", "س=١٢"], ans: 0 }
        ],
        u4l4: [ // معادلات بكسور
            { q: "س/٢ + ٣ = ٥", opts: ["س=٤", "س=١", "س=٢", "س=١٠"], ans: 0 },
            { q: "(س/٣) - ٢ = ١", opts: ["س=٩", "س=٣", "س=١", "س=١٢"], ans: 0 },
            { q: "٢س/٥ = ٤", opts: ["س=١٠", "س=٢.٥", "س=٢٠", "س=٤٠"], ans: 0 },
            { q: "(س+١)/٢ = ٣", opts: ["س=٥", "س=٧", "س=٦", "س=٢"], ans: 0 },
            { q: "(س/٤) + ١ = ٣", opts: ["س=٨", "س=١٦", "س=٤", "س=١٢"], ans: 0 },
            { q: "(٢س)/٣ = ٨", opts: ["س=١٢", "س=٢٤", "س=٦", "س=٨"], ans: 0 },
            { q: "(س-٢)/٣ = ٤", opts: ["س=١٤", "س=١٠", "س=١٢", "س=٦"], ans: 0 },
            { q: "(٣س)/٥ = ٩", opts: ["س=١٥", "س=٢٧", "س=٣", "س=٤٥"], ans: 0 },
            { q: "(س/٢)+(س/٣)=٥", opts: ["س=٦", "س=١٠", "س=١٢", "س=٣٠"], ans: 0 },
            { q: "(٢س-١)/٣ = ٥", opts: ["س=٨", "س=٧", "س=٩", "س=٦"], ans: 0 }
        ],
        u4l5: [ // مسائل تطبيقية
            { q: "مجموع عدد و٥ يساوي ١٢، ما العدد؟", opts: ["٧", "١٧", "٦٠", "٢"], ans: 0 },
            { q: "ثلاثة أمثال عدد تساوي ٢٤، ما العدد؟", opts: ["٨", "٢١", "٢٧", "١٢"], ans: 0 },
            { q: "عمر أحمد ١٢ سنة، وأخوه ضعفه، كم مجموع عمريهما؟", opts: ["٣٦", "٢٤", "١٢", "٤٨"], ans: 0 },
            { q: "اشترى محمد ٣ كتب بـ ٢٠ جنيهاً ودفتر بـ ٥ جنيهات، كم دفع؟", opts: ["٦٥", "٢٥", "٣٠", "٣٥"], ans: 0 },
            { q: "مستطيل طوله يزيد عن عرضه ٣ سم، ومحيطه ٢٢ سم، فما طوله؟", opts: ["٧ سم", "٥ سم", "٤ سم", "٨ سم"], ans: 0 },
            { q: "عدد إذا أضفت إليه ٨ ثم ضاعفت الناتج تحصل على ٣٠، ما العدد؟", opts: ["٧", "٦", "٨", "٩"], ans: 0 },
            { q: "سعر قلم ٥ ج، دفتر ١٠ ج، كم ثمن ٣ أقلام ودفترين؟", opts: ["٣٥", "٢٥", "٤٠", "٣٠"], ans: 0 },
            { q: "مجموع ثلاثة أعداد متتالية ٣٠، فما أصغرها؟", opts: ["٩", "١٠", "١١", "٨"], ans: 0 },
            { q: "عمر أميرة ضعف عمر أختها، ومجموعهما ٢٧، فما عمر أختها؟", opts: ["٩", "١٨", "٢٧", "١٣.٥"], ans: 0 },
            { q: "اشترى خالد ٨ دفاتر بـ ٦ ريالات ودفع ١٠٠ ريال، كم الباقي؟", opts: ["٥٢", "٤٨", "٦٨", "٧٢"], ans: 0 }
        ],
        u4l6: [ // معادلات تربيعية بسيطة
            { q: "حل س² = ٩", opts: ["س = ٣ أو -٣", "س = ٣", "س = -٣", "س = ٩"], ans: 0 },
            { q: "حل س² = ١٦", opts: ["س = ٤ أو -٤", "س = ٤", "س = -٤", "س = ١٦"], ans: 0 },
            { q: "حل س² = ٢٥", opts: ["س = ٥ أو -٥", "س = ٥", "س = -٥", "س = ٢٥"], ans: 0 },
            { q: "حل ٢س² = ٣٢", opts: ["س = ٤ أو -٤", "س = ٤", "س = -٤", "س = ١٦"], ans: 0 },
            { q: "حل س² - ٤ = ٠", opts: ["س = ٢ أو -٢", "س = ٢", "س = -٢", "س = ٤"], ans: 0 },
            { q: "حل س² - ٤٩ = ٠", opts: ["س = ٧ أو -٧", "س = ٧", "س = -٧", "س = ٤٩"], ans: 0 },
            { q: "حل (س-٢)² = ٠", opts: ["س = ٢", "س = -٢", "س = ٢ أو -٢", "س = ٤"], ans: 0 },
            { q: "حل س²+٦س+٩ = ٠", opts: ["س = -٣", "س = ٣", "س = ٣ أو -٣", "س = ٩"], ans: 0 },
            { q: "حل س²-١٠س+٢٥ = ٠", opts: ["س = ٥", "س = -٥", "س = ٥ أو -٥", "س = ٢٥"], ans: 0 },
            { q: "مجموعة حل س² = ٣٦", opts: ["{٦، -٦}", "{٦}", "{-٦}", "{٣٦}"], ans: 0 }
        ],
        u4l7: [ // حل بالتحليل
            { q: "حل س²+٥س+٦=٠", opts: ["س=-٢ أو -٣", "س=٢ أو ٣", "س=-٥ أو -١", "س=٦"], ans: 0 },
            { q: "حل س²-٥س+٦=٠", opts: ["س=٢ أو ٣", "س=-٢ أو -٣", "س=٥ أو ١", "س=٦"], ans: 0 },
            { q: "حل س²+٧س+١٠=٠", opts: ["س=-٢ أو -٥", "س=٢ أو ٥", "س=-٧ أو -١٠", "س=١٠"], ans: 0 },
            { q: "حل س²-٨س+١٥=٠", opts: ["س=٣ أو ٥", "س=-٣ أو -٥", "س=٨ أو ١٥", "س=٤"], ans: 0 },
            { q: "حل س²-٤=٠ بالتحليل", opts: ["(س-٢)(س+٢)=٠، س=٢ أو -٢", "س=٢", "س=-٢", "س=٤"], ans: 0 },
            { q: "حل ٢س²+٧س+٣=٠", opts: ["س=-١/٢ أو -٣", "س=١/٢ أو ٣", "س=-٢ أو -٣", "س=٣"], ans: 0 },
            { q: "حل ٣س²+١٠س+٨=٠", opts: ["س=-٤/٣ أو -٢", "س=٤/٣ أو ٢", "س=-٢ أو -٤", "س=٨"], ans: 0 },
            { q: "حل س²-٩س+٢٠=٠", opts: ["س=٤ أو ٥", "س=-٤ أو -٥", "س=٩ أو ٢٠", "س=١٠"], ans: 0 },
            { q: "حل س²+س-١٢=٠", opts: ["س=-٤ أو ٣", "س=٤ أو -٣", "س=١ أو -١٢", "س=١٢"], ans: 0 },
            { q: "مجموعة حل س²-٣س-١٠=٠", opts: ["{٥، -٢}", "{٢، -٥}", "{٥، ٢}", "{-٥، -٢}"], ans: 0 }
        ],

        // الوحدة 5
        u5l1: [ // المجال والمدى
            { q: "في {(١،٢)،(٢،٣)،(٣،٤)} المجال:", opts: ["{١،٢،٣}", "{٢،٣،٤}", "{(١،٢)}", "{١،٢،٣،٤}"], ans: 0 },
            { q: "المدى في العلاقة السابقة:", opts: ["{٢،٣،٤}", "{١،٢،٣}", "{(٢،٣)}", "{١،٢،٣،٤}"], ans: 0 },
            { q: "العلاقة س → ٢س، المجال {١،٢،٣}، فالمدى =", opts: ["{٢،٤،٦}", "{١،٢،٣}", "{٣،٥،٧}", "{٢،٣،٤}"], ans: 0 },
            { q: "في {(أ،٥)،(ب،٧)،(جـ،٩)} المدى =", opts: ["{٥،٧،٩}", "{أ،ب،جـ}", "{(أ،٥)}", "{أ،ب،جـ،٥،٧،٩}"], ans: 0 },
            { q: "المجال = {٢،٤،٦}، س→س+١، فالمدى =", opts: ["{٣،٥،٧}", "{٢،٤،٦}", "{١،٢،٣}", "{٣،٤،٥}"], ans: 0 },
            { q: "عدد عناصر {(١،١)،(٢،٤)،(٣،٩)} =", opts: ["٣", "٦", "٩", "٢"], ans: 0 },
            { q: "العلاقة ص=س²، س∈{٠،١،٢}، المدى =", opts: ["{٠،١،٤}", "{٠،١،٢}", "{٠،٢،٤}", "{١،٤}"], ans: 0 },
            { q: "أي مما يلي علاقة؟", opts: ["{(١،٢)،(٣،٤)}", "{١،٢،٣}", "{٢،٤،٦}", "جميع ما سبق"], ans: 0 },
            { q: "العلاقة دالة تعني:", opts: ["لكل س قيمة وحيدة في ص", "لكل ص قيمة وحيدة في س", "المجال=المدى", "عدد العناصر متساو"], ans: 0 },
            { q: "أي العلاقات دالة؟", opts: ["{(١،٢)،(٢،٢)،(٣،٢)}", "{(١،٢)،(١،٣)،(٢،٤)}", "{(٢،١)،(٣،١)،(٢،٣)}", "{(١،٢)،(٢،٣)،(٢،٤)}"], ans: 0 }
        ],
        u5l2: [ // تمثيل بياني
            { q: "(٢،٣) في الربع:", opts: ["الأول", "الثاني", "الثالث", "الرابع"], ans: 0 },
            { q: "(-٣،٤) في الربع:", opts: ["الثاني", "الأول", "الثالث", "الرابع"], ans: 0 },
            { q: "(-٢،-٥) في الربع:", opts: ["الثالث", "الثاني", "الأول", "الرابع"], ans: 0 },
            { q: "(٤،-٣) في الربع:", opts: ["الرابع", "الثالث", "الثاني", "الأول"], ans: 0 },
            { q: "نقطة الأصل:", opts: ["(٠،٠)", "(١،١)", "(٠،١)", "(١،٠)"], ans: 0 },
            { q: "المسافة بين (١،٢) و (١،٥) =", opts: ["٣", "٤", "٥", "٦"], ans: 0 },
            { q: "المسافة بين (٢،٣) و (٥،٣) =", opts: ["٣", "٤", "٥", "٦"], ans: 0 },
            { q: "تمثيل {(١،٢)،(٢،٣)،(٣،٤)} يعطي:", opts: ["نقاطاً متفرقة", "خطاً مستقيماً", "منحنى", "دائرة"], ans: 0 },
            { q: "نقطة على محور السينات:", opts: ["(٣،٠)", "(٠،٣)", "(-٣،٣)", "(٣،-٣)"], ans: 0 },
            { q: "نقطة على محور الصادات:", opts: ["(٠،٤)", "(٤،٠)", "(-٤،٤)", "(٤،-٤)"], ans: 0 }
        ],
        u5l3: [ // دوال مقدمة
            ...
            { q: "د(س)=س+٣، د(٢)+د(١) =", opts: ["(٥)+(٤)=٩", "٩", "١٠", "١١"], ans: 0 },
            { q: "د(س)=٢س²، د(٣) =", opts: ["١٨", "١٢", "٦", "٣٦"], ans: 0 },
            { q: "د(س)=٤س-١، د(٢)-د(١) =", opts: ["(٧)-(٣)=٤", "٤", "٥", "٦"], ans: 0 },
            { q: "د(س)=٩-س، د(٥) =", opts: ["٤", "١٤", "-٤", "٩"], ans: 0 },
        ...
        u5l4: [ // تطبيقات دوال
            { q: "د(س)=٢س+٣، د(٤)-د(٢) =", opts: ["١١-٧=٤", "٤", "٥", "٦"], ans: 0 },
            { q: "مساحة مربع طول ضلعه س:", opts: ["د(س)=س²", "د(س)=٤س", "د(س)=س+س", "د(س)=٢س"], ans: 0 },
            { q: "محيط مربع طول ضلعه س:", opts: ["د(س)=٤س", "د(س)=س²", "د(س)=٢س", "د(س)=س+٤"], ans: 0 },
            { q: "د(س)=١٠-٢س، د(٣) =", opts: ["٤", "١٦", "-٤", "١٠"], ans: 0 },
            { q: "د(س)=٣س-٥، أوجد س عندما د(س)=١", opts: ["س=٢", "س=٤", "س=٦", "س=-٢"], ans: 0 },
            { q: "د(س)=٨-س، د(٢)×د(١) =", opts: ["٦×٧=٤٢", "٤٢", "٤٠", "٤٨"], ans: 0 },
            { q: "مساحة مستطيل طوله ضعف عرضه س:", opts: ["د(س)=٢س²", "د(س)=٢س", "د(س)=س²", "د(س)=٤س"], ans: 0 },
            { q: "د(س)=س+٢، المجال {٠،١،٢}، المدى =", opts: ["{٢،٣،٤}", "{٠،١،٢}", "{٢،٣،٤}", "{٢،٤،٦}"], ans: 0 },
            { q: "د(س)=٤س-١، د(س)=١١، فإن س =", opts: ["٣", "٤", "٥", "٢"], ans: 0 },
            { q: "أي من التالي دالة خطية؟", opts: ["د(س)=٥س+٣", "د(س)=س²", "د(س)=|س|", "د(س)=٦"], ans: 0 }
        ]
    };
